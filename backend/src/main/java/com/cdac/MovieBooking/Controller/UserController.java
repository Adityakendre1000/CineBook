...
public class UserController {
        ...
        public ResponseEntity<ApiResponse<UserUpdateRequest>> updateUser(
        ...
        public ResponseEntity<ApiResponse<BookingResponse>> getBookingById(
                ...
                BookingResponse booking = us.getBookingById(bookingId, userDetails.getUserId());
        ...
        public ResponseEntity<ApiResponse<String>> verifyPayment(@RequestBody PaymentVerifyRequest request,
                        Authentication authentication) {
                CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal();
        ...
        public ResponseEntity<ApiResponse<String>> paymentFailure(@RequestBody PaymentFailureRequest request,
                        Authentication authentication) {
                CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal();
